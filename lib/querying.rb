...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(*) FROM characters INNER JOIN characters_books ON characters_books.character_id = characters.id GROUP BY characters.name ORDER BY COUNT(characters.book_id) DESC;"
end
